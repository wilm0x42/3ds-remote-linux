...
if [ $1 == 0 ]; then
    ...
    if [ -e ./work/prevframe.png ]; then
        ...
        convert ./work/newframe.png ./work/prevframe.png \( -clone 0 -clone 1 -compose difference -composite -threshold 0 \) -delete 1 -alpha off -compose copy_opacity -composite -interlace none ./work/frame.png
